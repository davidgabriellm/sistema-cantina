    ...
    <>
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="w-2/4 flex flex-col gap-7">
            <SheetClose asChild>
              <Link
                to="/"
                className="flex items-center  gap-3 mt-10 justify-start"
              >
      ...
      <div className=" hidden w-[5%] px-2 py-5 bg-gray-50 border border-gray-200 lg:flex items-center justify-start flex-col gap-4 h-screen sticky top-0 left-0 z-50">
        <TooltipProvider>
          <Link
            to="#"
            className="flex h-8 w-8 shrink-0 items-center justify-center bg-black/80 rounded-full"
          >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                to="/"
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-gray-700 transition-colors hover:text-foreground"
              >
